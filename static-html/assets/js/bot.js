! function(e, t) {
    ...
    return function(e) {
        ...
        */
        ...
        (t = e.exports = n(3)(!1)).push([e.i, "@import url(https://fonts.googleapis.com/css?family=Roboto);", ""]), t.push([e.i, ".conversation-container .replies{margin:10px;display:flex;flex-wrap:wrap;overflow:auto;font-size:14px;font-family:Roboto,serif}.conversation-container .reply{display:-webkit-box;display:-webkit-flex;display:-moz-box;display:-ms-flexbox;display:flex;-webkit-flex-align:center;-ms-flex-align:center;-webkit-align-items:center;align-items:center;border:1px solid #0084ff;border-radius:5px;color:#0084ff;padding:4px 8px;min-height:1.7em;text-align:center;font-family:Roboto,serif;cursor:pointer;margin:.25em}.conversation-container .response{background-color:#f4f7f9;color:#000;border-radius:0 15px 15px 15px;padding:11px 15px;text-align:left;font-family:Roboto,serif}.conversation-container .avatar{width:17px;height:17px;border-radius:100%;margin-right:6px;position:relative;bottom:5px}", ""])
    }, function(e, t, n) {
        var r = n(162);
        "string" == typeof r && (r = [
            [e.i, r, ""]
