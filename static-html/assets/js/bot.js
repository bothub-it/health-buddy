! function(e, t) {
    ...
    return function(e) {
        ...
        */
            ...
            d = (0, o.forwardRef)((function(e, n) {
                var o = new(function() {
                        function e(t, n, r, o, i, a) {
                            ...
                            }(this, e), this.url = t, this.customData = n, this.protocolOptions = r, this.channelUuid = o, this.host = i, this.onSocketEvent = a, this.socket = null, this.onEvents = [], this.marker = Math.random()
                        }
                        return r(e, [{
                            key: "isInitialized",
                            value: function() {
                            ...
                            key: "subscribe",
                            value: function(e, t) {
                                this.socket.isSubscribed(e) || this.socket.subscribe(e).watch(t)
                            }
                        }, {
                            key: "emit",
        ...
        (t = e.exports = n(3)(!1)).push([e.i, "@import url(https://fonts.googleapis.com/css?family=Roboto);", ""]), t.push([e.i, ".conversation-container .message{margin:10px;display:flex;font-size:14px;font-family:Roboto,serif;flex-wrap:wrap}.conversation-container .message .markdown p{margin:0}.conversation-container .client{background-color:#1CABE2;color:#fff;border-radius:15px;padding:11px 15px;max-width:215px;text-align:left;font-family:Roboto,serif;margin-left:auto;overflow-wrap:break-word}.conversation-container .client a{color:#35cce6}.conversation-container .response{background-color:#f4f7f9;color:#000;border-radius:0 15px 15px 15px;padding:11px 15px;max-width:215px;text-align:left;font-family:Roboto,serif;overflow-wrap:break-word}.conversation-container .message-text{margin:0}.conversation-container .message-text .markdown p{margin-bottom:1em}.conversation-container .message-text .markdown p:last-child{margin-bottom:0}", ""])
    }, function(e, t, n) {
        "use strict";
        Object.defineProperty(t, "__esModule", {
            value: !0
        ...
        (t = e.exports = n(3)(!1)).push([e.i, "@import url(https://fonts.googleapis.com/css?family=Roboto);", ""]), t.push([e.i, ".conversation-container .replies{margin:10px;display:flex;flex-wrap:wrap;overflow:auto;font-size:14px;font-family:Roboto,serif}.conversation-container .reply{display:-webkit-box;display:-webkit-flex;display:-moz-box;display:-ms-flexbox;display:flex;-webkit-flex-align:center;-ms-flex-align:center;-webkit-align-items:center;align-items:center;border:1px solid #0084ff;border-radius:15px;color:#0084ff;padding:4px 8px;max-width:215px;min-height:1.7em;text-align:center;font-family:Roboto,serif;cursor:pointer;margin:.25em}.conversation-container .response{background-color:#f4f7f9;color:#000;border-radius:0 15px 15px 15px;padding:11px 15px;max-width:215px;text-align:left;font-family:Roboto,serif}.conversation-container .avatar{width:17px;height:17px;border-radius:100%;margin-right:6px;position:relative;bottom:5px}", ""])
    }, function(e, t, n) {
        var r = n(162);
        "string" == typeof r && (r = [
            [e.i, r, ""]
